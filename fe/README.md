...
- Project board cards now support Agile-style workflows with generated short card IDs (for example `pro-project-01`), sprint labels, file/image attachments, comments, and per-card activity history.
